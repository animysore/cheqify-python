...
img = cv2.imread("/home/poulami/Documents/Github/cheqify-python/server/static/img/964626.jpg")
...
im = img
crop_img = img[y:y+h, x:x+w]
date = crop_img[int(h*0.07):int(h*0.14), int(w*0.75):int(w*0.965)]
...
#cv2.waitKey(0)/home/poulami/Documents/Github/cheqify-python/server/data.db